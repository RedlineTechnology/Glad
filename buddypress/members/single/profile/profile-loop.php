		...
		<?php if ( bp_profile_group_has_fields() ) : ?>
			...
			<div class="bp-widget <?php bp_the_profile_group_slug(); ?>">
				...
				<table class="profile-fields bp-tables-user">
					...
					<?php echo '<!-- test are you here? -->'; ?>

					<?php // Let's add e-mail address to the Contact Information
					if( bp_get_the_profile_group_slug() == 'contact-information' ) { ?>
						<?php echo '<!-- yes! -->'; ?>
						<tr<?php bp_field_css_class(); ?>>

							<td class="label">Email Address</td>
							<td class="data"><p><a href="mailto:<?php bp_displayed_user_email(); ?>"><?php bp_displayed_user_email(); ?></a></p></td>
